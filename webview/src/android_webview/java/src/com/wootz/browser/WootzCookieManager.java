...
/**
 * WootzView equivalent of WebView's CookieManager.
 *
 * @see android.webkit.CookieManager
 */
public class WootzCookieManager {
  /** The class that's doing all the work. */
  private AwCookieManager awCookieManager_;

  private WootzCookieManager() {
    awCookieManager_ = new AwCookieManager();
  }

  /**
   * Sets whether WootzView instances should send and accept cookies.
   * @param accept whether WootzView instances should send and accept cookies
   */
  ...
  /**
   * Gets whether the WootzView instances send and accept cookies for file
   * scheme URLs.
   *
  ...
  /** Gets the singleton WootzCookieManager instance. */
  public synchronized static WootzCookieManager getInstance() {
     if (instance_ == null) {
       instance_ = new WootzCookieManager();
     }
     return instance_;
  }
  private static WootzCookieManager instance_ = null;
}
