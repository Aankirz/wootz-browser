...
import com.wootz.browser.WootzSettings;

/** Proxies between WootzSettings and ContentsSettings / WebSettings. */
public class WootzSettingsProxy extends WootzSettings {
  /** The AwContents powering the WootzView whose settings we're proxying. */
